...
// import 'package:agora_rtc_engine/rtc_remote_view.dart' as RtcLocalView;
...
void main() {
  ...
  group('SurfaceView', () {
    testWidgets('Show Local SurfaceView', (WidgetTester tester) async {
      ...
      expect(find.byType(RtcLocalView.SurfaceView), findsOneWidget);
  ...
  group('TextureView', () {
    testWidgets('Show Local TextureView', (WidgetTester tester) async {
      ...
      expect(find.byType(RtcLocalView.TextureView), findsOneWidget);
